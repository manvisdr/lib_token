...
{
	serial_.begin(INITIAL_BAUD_RATE, SERIAL_7E1, RX2PIN, -1);
...
void MeterReader::switch_baud()
{
	...
	{
		serial_.begin(INITIAL_BAUD_RATE, SERIAL_7E1, -1, TX2PIN);
	...
	if (params.new_baud)
	{
		...
		serial_.begin(*params.new_baud, SERIAL_7E1, RX2PIN, -1);
	}
	else
	{
		serial_.begin(INITIAL_BAUD_RATE, SERIAL_7E1, RX2PIN, -1);
